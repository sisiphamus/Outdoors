"""
Clean Chiefton — Kill all Chiefton processes, delete app data, and wipe AutomationProfile.
...
APPDATA_DIR = os.path.join(os.environ["APPDATA"], "chiefton-desktop")
AUTOMATION_PROFILE = os.path.join(os.environ["LOCALAPPDATA"], "Google", "Chrome", "AutomationProfile")

PROCESS_NAMES = ["Chiefton.exe", "chiefton.exe"]


def kill_processes():
    print("[1/3] Killing Chiefton + Chrome processes...")
    killed = False
    for name in PROCESS_NAMES:
        ...
        if result.returncode == 0:
            ...
            killed = True
    if not killed:
        print("  No Chiefton processes found.")
...
def main():
    ...
    print("[2/3] Removing Chiefton app data...")
