// ============================================================
// Chiefton Dashboard — Renderer (view-only live activity feed)
...
function setupTitlebar() {
  ...
  if (powerBtn) {
    powerBtn.title = 'Turn off Chiefton';
    powerBtn.addEventListener('click', async () => {
      ...
      if (chieftonRunning) {
        ...
        chieftonRunning = false;
        powerBtn.classList.remove('on');
        powerBtn.classList.add('off');
        powerBtn.title = 'Turn on Chiefton';
        setStatus('offline', 'Stopped');
      } else {
        setStatus('', 'Starting...');
        await window.electronAPI.startBackend();
        chieftonRunning = true;
