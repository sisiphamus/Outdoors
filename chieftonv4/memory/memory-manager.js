// Memory manager — reads/writes all 4 memory categories from chieftonv1/backend/bot/memory/.
...
export const MEMORY_ROOT = join(__dirname, '..', '..', 'chieftonv1', 'backend', 'bot', 'memory');
