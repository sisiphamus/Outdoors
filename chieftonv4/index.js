...
// chieftonv4 bridge adapter — exports the codex-bridge API.
...
const MEMORY_ROOT = join(__dirname, '..', 'chieftonv1', 'backend', 'bot', 'memory');

// Employee definitions — backward compat with chieftonv1's delegation system
const EMPLOYEES = {
  coder: {
    mode: 'code',
